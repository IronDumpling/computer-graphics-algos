...
int main(int argc, char * argv[])
{
  ...
  // Part 0. Prepare a random list of points in our set and random queries
  ...
  // Part 3. Calculate Distance using AABB Tree
  tic();
  ...
  for(int i = 0; i < queries.rows(); i++)
  {
    ...
    point_AABBTree_squared_distance(query,root,0,inf,tree_sqrD(i),closest_object);
  ...
  // Part 4. Check that solutions match.
  for(int i = 0;i < queries.rows(); i++)
  {
